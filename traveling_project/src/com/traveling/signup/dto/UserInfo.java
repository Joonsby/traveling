package com.traveling.signup.dto;

public class UserInfo {
	private String id,pw,name,news_agency,phone,email,email_addr,gender,post_code,
	road_addr,jibun_addr,detail_addr,reference_addr,mail,birth;
