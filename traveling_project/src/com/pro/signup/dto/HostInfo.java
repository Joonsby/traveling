package com.pro.signup.dto;

public class HostInfo {
	private String host_id,pw,name,news_agency,phone,business_num,mail,birth,
	gender,post_code,road_addr,jibun_addr,detail_addr,reference_addr;
