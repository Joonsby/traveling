...
import com.pro.room.dao.RoomManagementDAO;
...
public class RoomInsertService implements ControlQuery {
	...
	public String dataCon(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		String uploadPath = req.getRealPath("/images/room_images");
		...
		try {
			...
			RoomManagementDAO roomManagementDAO = RoomManagementDAO.instance();
