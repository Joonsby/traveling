...
<body>
	...
	<main>
		...
		<section class="hotel_recommend">
			<h2>가장 인기가 많은 숙소</h2>
			<a href="/stay/popular"><img src="images/view_all.png" alt="모두 보기" /></a>
		...
		<section id="best-review-stays">
			<div class="swiper mySwiper banner">
				<h2>가장 평점이 높은 숙소</h2>
				<a href="/stay/top-rated"><img src="images/view_all.png" alt="" /></a>
		...
		<!-- 가격이 저렴한 숙소 -->
 		<section class="popular_accomodation">
			<h2>가격이 저렴한 숙소</h2>
			<a href="/stay/low-price"><img src="images/view_all.png" alt="" /></a>
