...
<%@ page import="com.traveling.stay.dto.CheckInInfo"%>
				...
				<table>
					<tbody>
						...
						<tr>
							<th>체크인 시간</th>
							<td>
								<input type="text" name="check_in_time" placeholder="체크인 시간을 선택해주세요." readonly>
							</td>
						</tr>
						<tr>
							<th>체크아웃 시간</th>
							<td>
								<input type="text" name="check_out_time" placeholder="체크아웃 시간을 선택해주세요." readonly>
							</td>
						</tr>
						<tr>
							<th>객실 가격</th>
