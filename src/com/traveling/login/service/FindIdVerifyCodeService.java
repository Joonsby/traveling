...
public class FindIdVerifyCodeService implements DataControl {

	static FindIdVerifyCodeService instance = new FindIdVerifyCodeService();

	public static FindIdVerifyCodeService instance() {
		return instance;
	}
