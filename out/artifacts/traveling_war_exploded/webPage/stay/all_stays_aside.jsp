...
<aside id="filter-sheet">
	<div class="filter-sheet-header">
		<strong>필터</strong>
		<button type="button" id="filter-close-btn">×</button>
	</div>
	...
	<div class="filter-sheet-actions">
		<button type="button" id="filter-reset-btn">초기화</button>
		<button type="button" id="filter-apply-btn">적용</button>
	</div>
</aside>
