  ...
  <div class="find_container">
    ...
    <div id="email_method" class="find_method_section active">
      <table class="find_table">
        ...
        <tr>
          <td>
            <input type="text" id="email_name" placeholder="이름을 입력하세요." />
          </td>
        </tr>

        <tr>
          <td>
            <input type="email" id="email_contact" placeholder="이메일을 입력하세요." />
          </td>
        </tr>
    ...
    <div id="sms_method" class="find_method_section">
      <table class="find_table">
        ...
        <tr>
          <td>
            <input type="text" id="sms_name" placeholder="이름을 입력하세요." />
          </td>
        </tr>

        <tr>
          <td>
            <input type="tel" id="sms_contact" placeholder="휴대폰 번호를 입력하세요. (하이픈 제외)" />
          </td>
        </tr>
