...
function switchMethod(method) {
	...
	$('.find_method_section').hide().removeClass('active');
	$(`#${method}_method`).show().addClass('active');

	$('.find_tab_btn').removeClass('active');
	$(`#${method}_method .find_tab_btn`).removeClass('active');
	$(`#${method}_method button[onclick="switchMethod('${method}')"]`).addClass('active');
